...
set_property -name "strategy" -value "Performance_NetDelay_high" -objects [get_runs impl_1]
set_property -name "steps.place_design.args.directive" -value "ExtraNetDelay_high" -objects [get_runs impl_1]
