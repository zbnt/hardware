...
proc create_hier_cell_mitm { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins s_axi_stats_a] [get_bd_intf_pins eth2_stats/S_AXI]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins s_axi_stats_b] [get_bd_intf_pins eth3_stats/S_AXI]
  connect_bd_intf_net -intf_net detector_M_AXIS_A [get_bd_intf_pins detector/M_AXIS_A] [get_bd_intf_pins eth2_mac/s_axis_tx]
  ...
  connect_bd_net -net eth2_mac_tx_mac_aclk [get_bd_pins detector/m_axis_a_clk] [get_bd_pins eth2_mac/tx_mac_aclk]
  connect_bd_net -net eth3_mac_tx_mac_aclk [get_bd_pins detector/m_axis_b_clk] [get_bd_pins eth3_mac/tx_mac_aclk]
  ...
  connect_bd_net -net mac_loop_rx_mac_aclk [get_bd_pins detector/s_axis_b_clk] [get_bd_pins eth3_mac/rx_mac_aclk] [get_bd_pins eth3_stats/clk_rx]
  ...
  connect_bd_net -net mac_main_rx_mac_aclk [get_bd_pins detector/s_axis_a_clk] [get_bd_pins eth2_mac/rx_mac_aclk] [get_bd_pins eth2_stats/clk_rx]
  ...
  connect_bd_net -net reset_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins detector/s_axi_resetn] [get_bd_pins eth2_mac/s_axi_resetn] [get_bd_pins eth2_stats/rst_n] [get_bd_pins eth3_mac/s_axi_resetn] [get_bd_pins eth3_stats/rst_n] [get_bd_pins reset/peripheral_aresetn]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins gtx_clk] [get_bd_pins detector/s_axi_clk] [get_bd_pins eth2_mac/gtx_clk] [get_bd_pins eth2_mac/s_axi_aclk] [get_bd_pins eth2_stats/clk] [get_bd_pins eth3_mac/gtx_clk] [get_bd_pins eth3_mac/s_axi_aclk] [get_bd_pins eth3_stats/clk] [get_bd_pins reset/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net s_axi_detector_1 [get_bd_intf_pins mitm/s_axi_detector] [get_bd_intf_pins ps_interconnect/M08_AXI]
  ...
  connect_bd_intf_net -intf_net s_axi_mac_loop_1 [get_bd_intf_pins mitm/s_axi_mac_b] [get_bd_intf_pins ps_interconnect/M06_AXI]
  connect_bd_intf_net -intf_net s_axi_mac_main_1 [get_bd_intf_pins mitm/s_axi_mac_a] [get_bd_intf_pins ps_interconnect/M07_AXI]
  ...
  connect_bd_intf_net -intf_net s_axi_stats_loop_1 [get_bd_intf_pins mitm/s_axi_stats_b] [get_bd_intf_pins ps_interconnect/M10_AXI]
  connect_bd_intf_net -intf_net s_axi_stats_main_1 [get_bd_intf_pins mitm/s_axi_stats_a] [get_bd_intf_pins ps_interconnect/M09_AXI]
  ...
  connect_bd_net -net eth0_mac_gtx_clk90_out [get_bd_pins eth0/gtx_clk90_out] [get_bd_pins eth1/gtx_clk90] [get_bd_pins mitm/gtx_clk90]
  ...
  connect_bd_net -net gtx_clk_1 [get_bd_pins eth0/gtx_clk_out] [get_bd_pins eth1/gtx_clk] [get_bd_pins mitm/gtx_clk] [get_bd_pins ps_interconnect/M06_ACLK] [get_bd_pins ps_interconnect/M07_ACLK] [get_bd_pins ps_interconnect/M08_ACLK] [get_bd_pins ps_interconnect/M09_ACLK] [get_bd_pins ps_interconnect/M10_ACLK] [get_bd_pins ps_interconnect/M11_ACLK] [get_bd_pins simple_timer/clk]
  connect_bd_net -net ps_main_FCLK_RESET0_N [get_bd_pins eth0/rst_n] [get_bd_pins eth1/rst_n] [get_bd_pins mitm/rst_n] [get_bd_pins ps_main/FCLK_RESET0_N] [get_bd_pins ps_reset/ext_reset_in]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43CE0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/detector/S_AXI/S_AXI_ADDR] SEG_detector_S_AXI_ADDR
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/eth2_mac/s_axi/Reg] SEG_eth2_mac_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43CB0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/eth2_stats/S_AXI/S_AXI_ADDR] SEG_eth2_stats_S_AXI_ADDR
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/eth3_mac/s_axi/Reg] SEG_eth3_mac_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43CA0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/eth3_stats/S_AXI/S_AXI_ADDR] SEG_eth3_stats_S_AXI_ADDR
