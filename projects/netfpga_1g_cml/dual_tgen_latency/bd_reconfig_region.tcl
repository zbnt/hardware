...
proc create_hier_cell_latency { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_LOOP

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_MAIN

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_LOOP

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_MAIN
  ...
  # Create pins
  create_bd_pin -dir I clk_rx_loop
  create_bd_pin -dir I clk_rx_main
...
proc create_hier_cell_dma_fifos { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins axis_regslice/aclk] [get_bd_pins fifo_0/s_aclk] [get_bd_pins fifo_1/s_aclk] [get_bd_pins fifo_2/s_aclk] [get_bd_pins fifo_3/s_aclk] [get_bd_pins fifo_4/s_aclk] [get_bd_pins fifo_7/s_aclk] [get_bd_pins switch/aclk]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axis_regslice/aresetn] [get_bd_pins fifo_0/s_aresetn] [get_bd_pins fifo_1/s_aresetn] [get_bd_pins fifo_2/s_aresetn] [get_bd_pins fifo_3/s_aresetn] [get_bd_pins fifo_4/s_aresetn] [get_bd_pins fifo_7/s_aresetn] [get_bd_pins switch/aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_AXIS_A_1 [get_bd_intf_ports S_AXIS_ETH2] [get_bd_intf_pins latency/S_AXIS_MAIN]
  connect_bd_intf_net -intf_net S_AXIS_B_1 [get_bd_intf_ports S_AXIS_ETH3] [get_bd_intf_pins latency/S_AXIS_LOOP]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M05_AXI [get_bd_intf_pins interconnect/M05_AXI] [get_bd_intf_pins latency/s_axi_stats_loop]
  ...
  connect_bd_intf_net -intf_net interconnect_M08_AXI [get_bd_intf_pins dtb_rom/S_AXI] [get_bd_intf_pins interconnect/M08_AXI]
  connect_bd_intf_net -intf_net latency_axis_ping [get_bd_intf_pins dma_fifos/S04_AXIS] [get_bd_intf_pins latency/axis_ping]
  connect_bd_intf_net -intf_net mitm_M_AXIS_A [get_bd_intf_ports M_AXIS_ETH2] [get_bd_intf_pins latency/M_AXIS_MAIN]
  connect_bd_intf_net -intf_net mitm_M_AXIS_B [get_bd_intf_ports M_AXIS_ETH3] [get_bd_intf_pins latency/M_AXIS_LOOP]
  connect_bd_intf_net -intf_net mitm_axis_stats_a [get_bd_intf_pins dma_fifos/S02_AXIS] [get_bd_intf_pins latency/axis_stats_main]
  connect_bd_intf_net -intf_net mitm_axis_stats_b [get_bd_intf_pins dma_fifos/S03_AXIS] [get_bd_intf_pins latency/axis_stats_loop]
  connect_bd_intf_net -intf_net s_axi_detector_1 [get_bd_intf_pins interconnect/M04_AXI] [get_bd_intf_pins latency/s_axi_measurer]
  ...
  connect_bd_intf_net -intf_net s_axi_stats_main_1 [get_bd_intf_pins interconnect/M06_AXI] [get_bd_intf_pins latency/s_axi_stats_main]
  ...
  assign_bd_address -offset 0x00008000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs latency/measurer/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs simple_timer/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth0/stats/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00003000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth1/stats/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00004000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs latency/stats_eth2/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00005000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs latency/stats_eth3/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00006000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth0/tgen/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00007000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth1/tgen/S_AXI/S_AXI_ADDR] -force
