...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_switch_0_M00_AXIS [get_bd_intf_pins fifo_4/S_AXIS] [get_bd_intf_pins switch/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net fifo_6_M_AXIS [get_bd_intf_pins dma/S_AXIS_S2MM] [get_bd_intf_pins fifo_4/M_AXIS]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins fifo_0/s_axis_aclk] [get_bd_pins fifo_1/s_axis_aclk] [get_bd_pins fifo_2/s_axis_aclk] [get_bd_pins fifo_3/s_axis_aclk] [get_bd_pins fifo_4/s_axis_aclk] [get_bd_pins switch/aclk]
  connect_bd_net -net clk_pcie_1 [get_bd_pins axi_pcie_clk] [get_bd_pins datamover/m_axi_s2mm_aclk] [get_bd_pins datamover/m_axis_s2mm_cmdsts_awclk] [get_bd_pins dma/clk] [get_bd_pins fifo_4/m_axis_aclk]
  ...
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins fifo_0/s_axis_aresetn] [get_bd_pins fifo_1/s_axis_aresetn] [get_bd_pins fifo_2/s_axis_aresetn] [get_bd_pins fifo_3/s_axis_aresetn] [get_bd_pins fifo_4/s_axis_aresetn] [get_bd_pins switch/aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_AXI_CTL_1 [get_bd_intf_pins axi_smartconnect/M11_AXI] [get_bd_intf_pins pcie/S_AXI_CTL]
  ...
  connect_bd_intf_net -intf_net axi_smartconnect_M10_AXI [get_bd_intf_pins axi_smartconnect/M10_AXI] [get_bd_intf_pins dma/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net eth2_axis_stats [get_bd_intf_pins dma/S02_AXIS] [get_bd_intf_pins eth2/axis_stats]
  ...
  connect_bd_net -net clk_wiz_0_clk_125M [get_bd_pins axi_smartconnect/aclk1] [get_bd_pins dcm_eth/clk_125M] [get_bd_pins dma/clk] [get_bd_pins eth0/clk_125M] [get_bd_pins eth1/clk_125M] [get_bd_pins eth2/clk_125M] [get_bd_pins eth3/clk_125M] [get_bd_pins reset_sys_clk/slowest_sync_clk] [get_bd_pins simple_timer/clk]
  ...
  connect_bd_net -net irq_1 [get_bd_pins dma/irq] [get_bd_pins pcie/irq]
  connect_bd_net -net pcie_axi_pcie_rst_n [get_bd_pins dma/axi_pcie_rst_n] [get_bd_pins pcie/axi_pcie_rst_n]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00070000 [get_bd_addr_spaces pcie/axi_pcie/M_AXI] [get_bd_addr_segs eth2/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR2
  create_bd_addr_seg -range 0x00010000 -offset 0x00080000 [get_bd_addr_spaces pcie/axi_pcie/M_AXI] [get_bd_addr_segs eth3/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR3
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x000B0000 [get_bd_addr_spaces pcie/axi_pcie/M_AXI] [get_bd_addr_segs eth2/tgen/S_AXI/S_AXI_ADDR] SEG_tgen_S_AXI_ADDR2
  create_bd_addr_seg -range 0x00010000 -offset 0x000C0000 [get_bd_addr_spaces pcie/axi_pcie/M_AXI] [get_bd_addr_segs eth3/tgen/S_AXI/S_AXI_ADDR] SEG_tgen_S_AXI_ADDR3
