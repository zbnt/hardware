...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_register_slice_0_M_AXI [get_bd_intf_pins M_AXI] [get_bd_intf_pins axi_regslice/M_AXI]
  ...
  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins fifo_0/s_axis_aclk] [get_bd_pins fifo_1/s_axis_aclk] [get_bd_pins fifo_2/s_axis_aclk] [get_bd_pins fifo_3/s_axis_aclk] [get_bd_pins fifo_4/s_aclk] [get_bd_pins switch/aclk]
  connect_bd_net -net clk_pcie_1 [get_bd_pins axi_pcie_clk] [get_bd_pins axi_regslice/aclk] [get_bd_pins dma/clk] [get_bd_pins fifo_4/m_aclk]
  connect_bd_net -net dma_irq [get_bd_pins irq] [get_bd_pins dma/irq]
  connect_bd_net -net fifo_4_axis_rd_data_count [get_bd_pins dma/fifo_occupancy] [get_bd_pins fifo_4/axis_rd_data_count]
  connect_bd_net -net rst_axi_pcie_n_1 [get_bd_pins axi_pcie_rst_n] [get_bd_pins axi_regslice/aresetn] [get_bd_pins dma/rst_n]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins fifo_0/s_axis_aresetn] [get_bd_pins fifo_1/s_axis_aresetn] [get_bd_pins fifo_2/s_axis_aresetn] [get_bd_pins fifo_3/s_axis_aresetn] [get_bd_pins fifo_4/s_aresetn] [get_bd_pins switch/aresetn]
