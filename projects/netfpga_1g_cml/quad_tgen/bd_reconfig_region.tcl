...
proc create_hier_cell_dma_fifos { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net fifo_7_M_AXIS [get_bd_intf_pins fifo_4/M_AXIS] [get_bd_intf_pins shutdown_axis/S_AXIS]
  ...
  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins axis_regslice/aclk] [get_bd_pins fifo_0/s_aclk] [get_bd_pins fifo_1/s_aclk] [get_bd_pins fifo_2/s_aclk] [get_bd_pins fifo_3/s_aclk] [get_bd_pins fifo_4/s_aclk] [get_bd_pins shutdown_axis/clk] [get_bd_pins switch/aclk]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axis_regslice/aresetn] [get_bd_pins fifo_0/s_aresetn] [get_bd_pins fifo_1/s_aresetn] [get_bd_pins fifo_2/s_aresetn] [get_bd_pins fifo_3/s_aresetn] [get_bd_pins fifo_4/s_aresetn] [get_bd_pins shutdown_axis/rst_n] [get_bd_pins switch/aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net eth2_shutdown_ack [get_bd_pins eth2/shutdown_ack] [get_bd_pins shutdown_concat/In4]
  connect_bd_net -net eth3_shutdown_ack [get_bd_pins eth3/shutdown_ack] [get_bd_pins shutdown_concat/In5]
  ...
  connect_bd_net -net shutdown_concat_dout [get_bd_pins shutdown_and/Op1] [get_bd_pins shutdown_concat/dout]
  connect_bd_net -net shutdown_req_0_1 [get_bd_ports shutdown_req] [get_bd_pins dma_fifos/shutdown_req] [get_bd_pins eth0/shutdown_req] [get_bd_pins eth1/shutdown_req] [get_bd_pins eth2/shutdown_req] [get_bd_pins eth3/shutdown_req] [get_bd_pins interconnect/shutdown_req]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00002000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs simple_timer/S_AXI/S_AXI_ADDR] SEG_simple_timer_S_AXI_ADDR
  create_bd_addr_seg -range 0x00001000 -offset 0x00004000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth0/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR
  create_bd_addr_seg -range 0x00001000 -offset 0x00006000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth1/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR1
  create_bd_addr_seg -range 0x00001000 -offset 0x00008000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth2/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR2
  create_bd_addr_seg -range 0x00001000 -offset 0x0000A000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth3/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR3
  create_bd_addr_seg -range 0x00002000 -offset 0x0000C000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth0/tgen/S_AXI/S_AXI_ADDR] SEG_tgen_S_AXI_ADDR
  create_bd_addr_seg -range 0x00002000 -offset 0x0000E000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth1/tgen/S_AXI/S_AXI_ADDR] SEG_tgen_S_AXI_ADDR1
  create_bd_addr_seg -range 0x00002000 -offset 0x00010000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth2/tgen/S_AXI/S_AXI_ADDR] SEG_tgen_S_AXI_ADDR2
  create_bd_addr_seg -range 0x00002000 -offset 0x00012000 [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth3/tgen/S_AXI/S_AXI_ADDR] SEG_tgen_S_AXI_ADDR3
