...
set dtb_data [split [exec ../../../scripts/gen_dtb_rom.py st_devtree.dts ST] "\n "]
set dtb_bram [get_cells -of_objects [all_fanin -flat [get_nets bd_static_i/dtb_rom/mem/douta[0]]] -filter {REF_NAME == RAMB36E1}]
