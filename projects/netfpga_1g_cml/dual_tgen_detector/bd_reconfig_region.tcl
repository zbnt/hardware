...
proc create_hier_cell_fifos_sc { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net fifo_6_M_AXIS1 [get_bd_intf_pins M_AXIS] [get_bd_intf_pins fifo_6/M_AXIS]
  connect_bd_intf_net -intf_net switch_sc_M00_AXIS [get_bd_intf_pins fifo_6/S_AXIS] [get_bd_intf_pins switch_sc/M00_AXIS]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins fifo_0/s_aclk] [get_bd_pins fifo_1/s_aclk] [get_bd_pins fifo_2/s_aclk] [get_bd_pins fifo_3/s_aclk] [get_bd_pins fifo_6/s_aclk] [get_bd_pins switch_sc/aclk]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins fifo_0/s_aresetn] [get_bd_pins fifo_1/s_aresetn] [get_bd_pins fifo_2/s_aresetn] [get_bd_pins fifo_3/s_aresetn] [get_bd_pins fifo_6/s_aresetn] [get_bd_pins switch_sc/aresetn]
...
proc create_hier_cell_dma_fifos { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net fifo_6_M_AXIS1 [get_bd_intf_pins fifos_sc/M_AXIS] [get_bd_intf_pins switch_main/S02_AXIS]
  connect_bd_intf_net -intf_net fifo_7_M_AXIS [get_bd_intf_pins axis_regslice/S_AXIS] [get_bd_intf_pins fifo_2/M_AXIS]
  connect_bd_intf_net -intf_net reg_slice_M_AXIS [get_bd_intf_pins M_AXIS] [get_bd_intf_pins axis_regslice/M_AXIS]
  connect_bd_intf_net -intf_net switch_M00_AXIS [get_bd_intf_pins fifo_2/S_AXIS] [get_bd_intf_pins switch_main/M00_AXIS]

  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins axis_regslice/aclk] [get_bd_pins fifo_0/s_aclk] [get_bd_pins fifo_1/s_aclk] [get_bd_pins fifo_2/s_aclk] [get_bd_pins fifos_sc/clk] [get_bd_pins switch_main/aclk]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axis_regslice/aresetn] [get_bd_pins fifo_0/s_aresetn] [get_bd_pins fifo_1/s_aresetn] [get_bd_pins fifo_2/s_aresetn] [get_bd_pins fifos_sc/rst_n] [get_bd_pins switch_main/aresetn]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x00100000 -range 0x00020000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs mitm/detector/S_AXI/S_AXI_ADDR] -force
  ...
  assign_bd_address -offset 0x00040000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth0/stats/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00060000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth1/stats/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x00080000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs mitm/stats_a/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x000A0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs mitm/stats_b/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x000C0000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth0/tgen/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x000E0000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S_AXI_PCIE] [get_bd_addr_segs eth1/tgen/S_AXI/S_AXI_ADDR] -force
