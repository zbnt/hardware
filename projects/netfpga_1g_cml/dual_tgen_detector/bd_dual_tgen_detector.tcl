...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_AXI_WIDTH {64} \
   CONFIG.C_VALUE_AWCACHE {"0000"} \
   CONFIG.C_VALUE_AWUSER {"0000"} \
 ] $dma
  ...
  # Create port connections
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins fifo_0/s_axis_aclk] [get_bd_pins fifo_1/s_axis_aclk] [get_bd_pins fifo_2/s_axis_aclk] [get_bd_pins fifo_3/s_axis_aclk] [get_bd_pins fifo_4/s_axis_aclk] [get_bd_pins fifo_5/s_axis_aclk] [get_bd_pins fifo_6/s_aclk] [get_bd_pins switch/aclk]
  connect_bd_net -net clk_pcie_1 [get_bd_pins axi_pcie_clk] [get_bd_pins axi_regslice/aclk] [get_bd_pins dma/clk] [get_bd_pins fifo_6/m_aclk]
  ...
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins fifo_0/s_axis_aresetn] [get_bd_pins fifo_1/s_axis_aresetn] [get_bd_pins fifo_2/s_axis_aresetn] [get_bd_pins fifo_3/s_axis_aresetn] [get_bd_pins fifo_4/s_axis_aresetn] [get_bd_pins fifo_5/s_axis_aresetn] [get_bd_pins fifo_6/s_aresetn] [get_bd_pins switch/aresetn]
