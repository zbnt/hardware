...
proc create_hier_cell_eth3 { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 -type clk clk_rx
  ...
  connect_bd_net -net mac_main_rx_mac_aclk [get_bd_pins clk_tx] [get_bd_pins mac/gtx_clk] [get_bd_pins reset/slowest_sync_clk] [get_bd_pins stats/clk_tx]
  connect_bd_net -net reset_peripheral_aresetn [get_bd_pins rst_n] [get_bd_pins reset/ext_reset_in] [get_bd_pins stats/rst_n]
  connect_bd_net -net reset_peripheral_aresetn1 [get_bd_pins mac/gtx_rst_n] [get_bd_pins reset/peripheral_aresetn]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins clk] [get_bd_pins stats/clk]
...
proc create_hier_cell_eth2 { parentCell nameHier } {
  ...
  connect_bd_net -net bufg_inst_BUFG_O [get_bd_pins clk_rx] [get_bd_pins mac/rx_clk] [get_bd_pins stats/clk_rx]
  connect_bd_net -net current_time_0_1 [get_bd_pins current_time] [get_bd_pins stats/current_time]
  connect_bd_net -net mac_loop_rx_mac_aclk [get_bd_pins clk_tx] [get_bd_pins mac/gtx_clk] [get_bd_pins reset/slowest_sync_clk] [get_bd_pins stats/clk_tx]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins mac/gtx_rst_n] [get_bd_pins reset/peripheral_aresetn]
  connect_bd_net -net reset_peripheral_aresetn [get_bd_pins rst_n] [get_bd_pins reset/ext_reset_in] [get_bd_pins stats/rst_n]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins clk] [get_bd_pins stats/clk]
  connect_bd_net -net time_running_0_1 [get_bd_pins time_running] [get_bd_pins stats/time_running]
...
proc create_hier_cell_fifos_sc { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S04_AXIS_1 [get_bd_intf_pins S00_AXIS] [get_bd_intf_pins fifo_sc_0/S_AXIS]
  connect_bd_intf_net -intf_net S05_AXIS_1 [get_bd_intf_pins S01_AXIS] [get_bd_intf_pins fifo_sc_1/S_AXIS]
  connect_bd_intf_net -intf_net S06_AXIS_1 [get_bd_intf_pins S02_AXIS] [get_bd_intf_pins fifo_sc_2/S_AXIS]
  connect_bd_intf_net -intf_net S07_AXIS_1 [get_bd_intf_pins S03_AXIS] [get_bd_intf_pins fifo_sc_3/S_AXIS]
  connect_bd_intf_net -intf_net fifo_4_M_AXIS [get_bd_intf_pins fifo_sc_0/M_AXIS] [get_bd_intf_pins switch_sc/S00_AXIS]
  connect_bd_intf_net -intf_net fifo_5_M_AXIS [get_bd_intf_pins fifo_sc_1/M_AXIS] [get_bd_intf_pins switch_sc/S01_AXIS]
  connect_bd_intf_net -intf_net fifo_6_M_AXIS [get_bd_intf_pins fifo_sc_2/M_AXIS] [get_bd_intf_pins switch_sc/S02_AXIS]
  connect_bd_intf_net -intf_net fifo_7_M_AXIS [get_bd_intf_pins fifo_sc_3/M_AXIS] [get_bd_intf_pins switch_sc/S03_AXIS]
  connect_bd_intf_net -intf_net fifo_8_M_AXIS [get_bd_intf_pins M_AXIS] [get_bd_intf_pins fifo_sc_4/M_AXIS]
  connect_bd_intf_net -intf_net switch_sc_M00_AXIS [get_bd_intf_pins fifo_sc_4/S_AXIS] [get_bd_intf_pins switch_sc/M00_AXIS]

  # Create port connections
  connect_bd_net -net ethfmc_clk_buf_IBUF_OUT [get_bd_pins clk] [get_bd_pins fifo_sc_0/s_aclk] [get_bd_pins fifo_sc_1/s_aclk] [get_bd_pins fifo_sc_2/s_aclk] [get_bd_pins fifo_sc_3/s_aclk] [get_bd_pins fifo_sc_4/s_aclk] [get_bd_pins switch_sc/aclk]
...
proc create_hier_cell_axi_out { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_regslice_M_AXI [get_bd_intf_pins axi_converter/S_AXI] [get_bd_intf_pins axi_regslice/M_AXI]
  connect_bd_intf_net -intf_net dma_M_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_regslice/S_AXI]

  # Create port connections
  connect_bd_net -net ethfmc_clk_buf_IBUF_OUT [get_bd_pins clk] [get_bd_pins axi_converter/aclk] [get_bd_pins axi_regslice/aclk]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axi_converter/aresetn] [get_bd_pins axi_regslice/aresetn]
...
proc create_hier_cell_mitm_b { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net eth3_mac_RGMII [get_bd_intf_pins rgmii_b] [get_bd_intf_pins eth3/rgmii]
  connect_bd_intf_net -intf_net eth3_mac_RX_AXIS [get_bd_intf_pins detector/S_AXIS_B] [get_bd_intf_pins eth3/RX_AXIS]
  connect_bd_intf_net -intf_net measurer_M_AXIS_LOOP [get_bd_intf_pins detector/M_AXIS_B] [get_bd_intf_pins eth3/TX_AXIS]
  connect_bd_intf_net -intf_net measurer_M_AXIS_MAIN [get_bd_intf_pins detector/M_AXIS_A] [get_bd_intf_pins eth2/TX_AXIS]

  # Create port connections
  connect_bd_net -net current_time_0_1 [get_bd_pins current_time] [get_bd_pins detector/current_time] [get_bd_pins eth2/current_time] [get_bd_pins eth3/current_time]
  connect_bd_net -net mac_loop_rx_mac_aclk [get_bd_pins detector/m_axis_a_clk] [get_bd_pins detector/s_axis_b_clk] [get_bd_pins eth2/clk_tx] [get_bd_pins eth3/clk_rx]
  connect_bd_net -net mac_main_rx_mac_aclk [get_bd_pins detector/m_axis_b_clk] [get_bd_pins detector/s_axis_a_clk] [get_bd_pins eth2/clk_rx] [get_bd_pins eth3/clk_tx]
  connect_bd_net -net reset_peripheral_aresetn [get_bd_pins rst_n] [get_bd_pins detector/s_axi_resetn] [get_bd_pins eth2/rst_n] [get_bd_pins eth3/rst_n]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins gtx_clk] [get_bd_pins detector/s_axi_clk] [get_bd_pins eth2/clk] [get_bd_pins eth3/clk]
  connect_bd_net -net time_running_0_1 [get_bd_pins time_running] [get_bd_pins detector/time_running] [get_bd_pins eth2/time_running] [get_bd_pins eth3/time_running]
...
proc create_hier_cell_mitm_a { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_detector] [get_bd_intf_pins detector/S_AXI]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins s_axi_stats_a] [get_bd_intf_pins eth0/S_AXI]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins s_axi_stats_b] [get_bd_intf_pins eth1/S_AXI]
  connect_bd_intf_net -intf_net detector_M_AXIS_LOG_A [get_bd_intf_pins axis_detector_a] [get_bd_intf_pins detector/M_AXIS_LOG_A]
  connect_bd_intf_net -intf_net detector_M_AXIS_LOG_B [get_bd_intf_pins axis_detector_b] [get_bd_intf_pins detector/M_AXIS_LOG_B]
  connect_bd_intf_net -intf_net eth2_axis_stats [get_bd_intf_pins axis_stats_a] [get_bd_intf_pins eth0/axis_stats]
  connect_bd_intf_net -intf_net eth2_mac_RGMII [get_bd_intf_pins rgmii_a] [get_bd_intf_pins eth0/rgmii]
  connect_bd_intf_net -intf_net eth2_mac_RX_AXIS [get_bd_intf_pins detector/S_AXIS_A] [get_bd_intf_pins eth0/RX_AXIS]
  connect_bd_intf_net -intf_net eth3_axis_stats [get_bd_intf_pins axis_stats_b] [get_bd_intf_pins eth1/axis_stats]
  connect_bd_intf_net -intf_net eth3_mac_RGMII [get_bd_intf_pins rgmii_b] [get_bd_intf_pins eth1/rgmii]
  connect_bd_intf_net -intf_net eth3_mac_RX_AXIS [get_bd_intf_pins detector/S_AXIS_B] [get_bd_intf_pins eth1/RX_AXIS]
  connect_bd_intf_net -intf_net measurer_M_AXIS_LOOP [get_bd_intf_pins detector/M_AXIS_B] [get_bd_intf_pins eth1/TX_AXIS]
  connect_bd_intf_net -intf_net measurer_M_AXIS_MAIN [get_bd_intf_pins detector/M_AXIS_A] [get_bd_intf_pins eth0/TX_AXIS]

  # Create port connections
  connect_bd_net -net current_time_0_1 [get_bd_pins current_time] [get_bd_pins detector/current_time] [get_bd_pins eth0/current_time] [get_bd_pins eth1/current_time]
  connect_bd_net -net mac_loop_rx_mac_aclk [get_bd_pins detector/m_axis_a_clk] [get_bd_pins detector/s_axis_b_clk] [get_bd_pins eth0/clk_tx] [get_bd_pins eth1/clk_rx]
  connect_bd_net -net mac_main_rx_mac_aclk [get_bd_pins detector/m_axis_b_clk] [get_bd_pins detector/s_axis_a_clk] [get_bd_pins eth0/clk_rx] [get_bd_pins eth1/clk_tx]
  connect_bd_net -net reset_peripheral_aresetn [get_bd_pins rst_n] [get_bd_pins detector/s_axi_resetn] [get_bd_pins eth0/rst_n] [get_bd_pins eth1/rst_n]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins gtx_clk] [get_bd_pins detector/s_axi_clk] [get_bd_pins eth0/clk] [get_bd_pins eth1/clk]
  connect_bd_net -net time_running_0_1 [get_bd_pins time_running] [get_bd_pins detector/time_running] [get_bd_pins eth0/time_running] [get_bd_pins eth1/time_running]
...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S04_AXIS_1 [get_bd_intf_pins S04_AXIS] [get_bd_intf_pins fifos_sc/S00_AXIS]
  connect_bd_intf_net -intf_net S05_AXIS_1 [get_bd_intf_pins S05_AXIS] [get_bd_intf_pins fifos_sc/S01_AXIS]
  connect_bd_intf_net -intf_net S06_AXIS_1 [get_bd_intf_pins S06_AXIS] [get_bd_intf_pins fifos_sc/S02_AXIS]
  connect_bd_intf_net -intf_net S07_AXIS_1 [get_bd_intf_pins S07_AXIS] [get_bd_intf_pins fifos_sc/S03_AXIS]
  ...
  connect_bd_intf_net -intf_net fifo_2_M_AXIS [get_bd_intf_pins fifo_2/M_AXIS] [get_bd_intf_pins switch_main/S02_AXIS]
  connect_bd_intf_net -intf_net fifo_3_M_AXIS [get_bd_intf_pins fifo_3/M_AXIS] [get_bd_intf_pins switch_main/S03_AXIS]
  connect_bd_intf_net -intf_net fifo_8_M_AXIS [get_bd_intf_pins fifos_sc/M_AXIS] [get_bd_intf_pins switch_main/S04_AXIS]
  connect_bd_intf_net -intf_net switch_main_M00_AXIS [get_bd_intf_pins dma/S_AXIS] [get_bd_intf_pins switch_main/M00_AXIS]

  # Create port connections
  connect_bd_net -net dma_irq [get_bd_pins irq] [get_bd_pins dma/irq]
  connect_bd_net -net ethfmc_clk_buf_IBUF_OUT [get_bd_pins clk] [get_bd_pins axi_out/clk] [get_bd_pins dma/clk] [get_bd_pins fifo_0/s_aclk] [get_bd_pins fifo_1/s_aclk] [get_bd_pins fifo_2/s_aclk] [get_bd_pins fifo_3/s_aclk] [get_bd_pins fifos_sc/clk] [get_bd_pins switch_main/aclk]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axi_out/rst_n] [get_bd_pins dma/rst_n] [get_bd_pins fifo_0/s_aresetn] [get_bd_pins fifo_1/s_aresetn] [get_bd_pins fifo_2/s_aresetn] [get_bd_pins fifo_3/s_aresetn] [get_bd_pins fifos_sc/rst_n] [get_bd_pins switch_main/aresetn]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net eth2_rgmii [get_bd_intf_ports ethfmc_p2_rgmii] [get_bd_intf_pins mitm_b/rgmii_a]
  connect_bd_intf_net -intf_net eth2_rgmii_loop [get_bd_intf_ports ethfmc_p3_rgmii] [get_bd_intf_pins mitm_b/rgmii_b]
  ...
  connect_bd_intf_net -intf_net mitm_a_axis_stats_b [get_bd_intf_pins dma/S05_AXIS] [get_bd_intf_pins mitm_a/axis_stats_b]
  connect_bd_intf_net -intf_net mitm_a_rgmii_a [get_bd_intf_ports ethfmc_p0_rgmii] [get_bd_intf_pins mitm_a/rgmii_a]
  connect_bd_intf_net -intf_net mitm_a_rgmii_b [get_bd_intf_ports ethfmc_p1_rgmii] [get_bd_intf_pins mitm_a/rgmii_b]
  ...
  connect_bd_intf_net -intf_net mitm_b_axis_detector_b [get_bd_intf_pins dma/S03_AXIS] [get_bd_intf_pins mitm_b/axis_detector_b]
  connect_bd_intf_net -intf_net mitm_b_axis_stats_a [get_bd_intf_pins dma/S06_AXIS] [get_bd_intf_pins mitm_b/axis_stats_a]
  connect_bd_intf_net -intf_net mitm_b_axis_stats_b [get_bd_intf_pins dma/S07_AXIS] [get_bd_intf_pins mitm_b/axis_stats_b]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins ethfmc_dcm/locked] [get_bd_pins ps_reset/dcm_locked]
  ...
  connect_bd_net -net ethfmc_clk_buf_IBUF_OUT [get_bd_pins dma/clk] [get_bd_pins ethfmc_dcm/clk_125M] [get_bd_pins mitm_a/gtx_clk] [get_bd_pins mitm_b/gtx_clk] [get_bd_pins ps_interconnect/ACLK] [get_bd_pins ps_interconnect/M00_ACLK] [get_bd_pins ps_interconnect/M01_ACLK] [get_bd_pins ps_interconnect/M02_ACLK] [get_bd_pins ps_interconnect/M03_ACLK] [get_bd_pins ps_interconnect/M04_ACLK] [get_bd_pins ps_interconnect/M05_ACLK] [get_bd_pins ps_interconnect/M06_ACLK] [get_bd_pins ps_interconnect/M07_ACLK] [get_bd_pins ps_interconnect/S00_ACLK] [get_bd_pins ps_main/M_AXI_GP0_ACLK] [get_bd_pins ps_main/S_AXI_ACP_ACLK] [get_bd_pins ps_reset/slowest_sync_clk] [get_bd_pins simple_timer/clk]
  ...
  assign_bd_address -offset 0x43CA0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm_a/detector/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x43CC0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm_b/detector/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x40400000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs dma/dma/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x43C00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs simple_timer/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x43C20000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm_a/eth0/stats/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x43C40000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm_a/eth1/stats/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x43C60000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm_b/eth2/stats/S_AXI/S_AXI_ADDR] -force
  assign_bd_address -offset 0x43C80000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm_b/eth3/stats/S_AXI/S_AXI_ADDR] -force
