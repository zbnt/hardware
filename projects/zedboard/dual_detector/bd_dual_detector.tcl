...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  set fifo_7 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 fifo_7 ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {64} \
   CONFIG.FIFO_MEMORY_TYPE {distributed} \
 ] $fifo_7
  ...
  connect_bd_intf_net -intf_net fifo_4_M_AXIS [get_bd_intf_pins fifo_4/M_AXIS] [get_bd_intf_pins switch_sc/S00_AXIS]
  connect_bd_intf_net -intf_net fifo_5_M_AXIS [get_bd_intf_pins fifo_5/M_AXIS] [get_bd_intf_pins switch_sc/S01_AXIS]
  connect_bd_intf_net -intf_net fifo_6_M_AXIS [get_bd_intf_pins fifo_6/M_AXIS] [get_bd_intf_pins switch_sc/S02_AXIS]
  connect_bd_intf_net -intf_net fifo_7_M_AXIS [get_bd_intf_pins fifo_7/M_AXIS] [get_bd_intf_pins switch_sc/S03_AXIS]
  connect_bd_intf_net -intf_net fifo_8_M_AXIS [get_bd_intf_pins fifo_8/M_AXIS] [get_bd_intf_pins switch_main/S04_AXIS]
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins dma/S_AXIS_S2MM] [get_bd_intf_pins fifo_9/M_AXIS]
  ...
  # Create port connections
  connect_bd_net -net dma_dm_rst_n [get_bd_pins dma/fifo_rst_n] [get_bd_pins fifo_0/s_axis_aresetn] [get_bd_pins fifo_1/s_axis_aresetn] [get_bd_pins fifo_2/s_axis_aresetn] [get_bd_pins fifo_3/s_axis_aresetn] [get_bd_pins fifo_4/s_axis_aresetn] [get_bd_pins fifo_5/s_axis_aresetn] [get_bd_pins fifo_6/s_axis_aresetn] [get_bd_pins fifo_7/s_axis_aresetn] [get_bd_pins fifo_8/s_axis_aresetn] [get_bd_pins fifo_9/s_aresetn] [get_bd_pins switch_main/aresetn] [get_bd_pins switch_sc/aresetn]
  connect_bd_net -net dma_irq [get_bd_pins irq] [get_bd_pins dma/irq]
  connect_bd_net -net ethfmc_clk_buf_IBUF_OUT [get_bd_pins clk] [get_bd_pins axi_converter/aclk] [get_bd_pins axi_regslice/aclk] [get_bd_pins dma/clk] [get_bd_pins fifo_0/s_axis_aclk] [get_bd_pins fifo_1/s_axis_aclk] [get_bd_pins fifo_2/s_axis_aclk] [get_bd_pins fifo_3/s_axis_aclk] [get_bd_pins fifo_4/s_axis_aclk] [get_bd_pins fifo_5/s_axis_aclk] [get_bd_pins fifo_6/s_axis_aclk] [get_bd_pins fifo_7/s_axis_aclk] [get_bd_pins fifo_8/s_axis_aclk] [get_bd_pins fifo_9/s_aclk] [get_bd_pins switch_main/aclk] [get_bd_pins switch_sc/aclk]
  connect_bd_net -net fifo_6_axis_data_count [get_bd_pins dma/fifo_occupancy] [get_bd_pins fifo_9/axis_data_count]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axi_converter/aresetn] [get_bd_pins axi_regslice/aresetn] [get_bd_pins dma/rst_n]
