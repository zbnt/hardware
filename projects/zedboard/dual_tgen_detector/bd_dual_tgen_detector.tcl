...
proc create_hier_cell_eth3 { parentCell nameHier } {
  ...
  connect_bd_net -net mac_loop_rx_mac_aclk [get_bd_pins bufg_inst/BUFG_I] [get_bd_pins fifo/s_aclk] [get_bd_pins mac/rx_clk]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43CB0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/detector/S_AXI/S_AXI_ADDR] SEG_detector_S_AXI_ADDR
