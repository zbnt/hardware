...
proc create_hier_cell_fifos_sc { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net fifo_sc_0_M_AXIS [get_bd_intf_pins fifo_sc_0/M_AXIS] [get_bd_intf_pins switch_sc/S00_AXIS]
  connect_bd_intf_net -intf_net fifo_sc_1_M_AXIS [get_bd_intf_pins fifo_sc_1/M_AXIS] [get_bd_intf_pins switch_sc/S01_AXIS]
  connect_bd_intf_net -intf_net fifo_sc_2_M_AXIS [get_bd_intf_pins fifo_sc_2/M_AXIS] [get_bd_intf_pins switch_sc/S02_AXIS]
  connect_bd_intf_net -intf_net fifo_sc_3_M_AXIS [get_bd_intf_pins fifo_sc_3/M_AXIS] [get_bd_intf_pins switch_sc/S03_AXIS]
  connect_bd_intf_net -intf_net fifo_sc_4_M_AXIS [get_bd_intf_pins M_AXIS] [get_bd_intf_pins fifo_sc_4/M_AXIS]
  connect_bd_intf_net -intf_net switch_sc_M00_AXIS [get_bd_intf_pins fifo_sc_4/S_AXIS] [get_bd_intf_pins switch_sc/M00_AXIS]

  # Create port connections
  connect_bd_net -net dma_dm_rst_n [get_bd_pins rst_n] [get_bd_pins fifo_sc_0/s_aresetn] [get_bd_pins fifo_sc_1/s_aresetn] [get_bd_pins fifo_sc_2/s_aresetn] [get_bd_pins fifo_sc_3/s_aresetn] [get_bd_pins fifo_sc_4/s_aresetn] [get_bd_pins switch_sc/aresetn]
...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S02_AXIS_1 [get_bd_intf_pins S02_AXIS] [get_bd_intf_pins fifos_sc/S00_AXIS]
  connect_bd_intf_net -intf_net S03_AXIS_1 [get_bd_intf_pins S03_AXIS] [get_bd_intf_pins fifos_sc/S01_AXIS]
  connect_bd_intf_net -intf_net S04_AXIS_1 [get_bd_intf_pins S04_AXIS] [get_bd_intf_pins fifos_sc/S02_AXIS]
  connect_bd_intf_net -intf_net S05_AXIS_1 [get_bd_intf_pins S05_AXIS] [get_bd_intf_pins fifos_sc/S03_AXIS]
  ...
  connect_bd_intf_net -intf_net fifo_6_M_AXIS [get_bd_intf_pins fifos_sc/M_AXIS] [get_bd_intf_pins switch_main/S02_AXIS]
  ...
  connect_bd_net -net ethfmc_clk_buf_IBUF_OUT [get_bd_pins clk] [get_bd_pins axi_out/clk] [get_bd_pins dma/clk] [get_bd_pins fifo_0/s_aclk] [get_bd_pins fifo_1/s_aclk] [get_bd_pins fifos_sc/clk] [get_bd_pins switch_main/aclk]
  connect_bd_net -net rst_n_1 [get_bd_pins rst_n] [get_bd_pins axi_out/rst_n] [get_bd_pins dma/rst_n] [get_bd_pins fifo_0/s_aresetn] [get_bd_pins fifo_1/s_aresetn] [get_bd_pins fifos_sc/rst_n] [get_bd_pins switch_main/aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins eth1/s_axi_stats] [get_bd_intf_pins ps_interconnect/M02_AXI]
  ...
  connect_bd_intf_net -intf_net eth0_axis_stats [get_bd_intf_pins dma/S04_AXIS] [get_bd_intf_pins eth0/axis_stats]
  connect_bd_intf_net -intf_net eth0_mac_rgmii [get_bd_intf_ports ethfmc_p0_rgmii] [get_bd_intf_pins eth0/rgmii]
  connect_bd_intf_net -intf_net eth1_axis_stats [get_bd_intf_pins dma/S05_AXIS] [get_bd_intf_pins eth1/axis_stats]
  ...
  connect_bd_intf_net -intf_net mitm_axis_detector_a [get_bd_intf_pins dma/S00_AXIS] [get_bd_intf_pins mitm/axis_detector_a]
  connect_bd_intf_net -intf_net mitm_axis_detector_b [get_bd_intf_pins dma/S01_AXIS] [get_bd_intf_pins mitm/axis_detector_b]
  ...
  connect_bd_intf_net -intf_net s_axi_detector_1 [get_bd_intf_pins mitm/s_axi_detector] [get_bd_intf_pins ps_interconnect/M06_AXI]
  connect_bd_intf_net -intf_net s_axi_stats_a_1 [get_bd_intf_pins mitm/s_axi_stats_a] [get_bd_intf_pins ps_interconnect/M05_AXI]
  connect_bd_intf_net -intf_net s_axi_stats_b_1 [get_bd_intf_pins mitm/s_axi_stats_b] [get_bd_intf_pins ps_interconnect/M04_AXI]
  connect_bd_intf_net -intf_net s_axi_tgen_1 [get_bd_intf_pins eth1/s_axi_tgen] [get_bd_intf_pins ps_interconnect/M03_AXI]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins eth0/rst_n] [get_bd_pins eth1/rst_n] [get_bd_pins mitm/rst_n] [get_bd_pins ps_interconnect/M00_ARESETN] [get_bd_pins ps_interconnect/M01_ARESETN] [get_bd_pins ps_interconnect/M02_ARESETN] [get_bd_pins ps_interconnect/M03_ARESETN] [get_bd_pins ps_interconnect/M04_ARESETN] [get_bd_pins ps_interconnect/M05_ARESETN] [get_bd_pins ps_interconnect/M06_ARESETN] [get_bd_pins ps_interconnect/M07_ARESETN] [get_bd_pins ps_interconnect/M08_ARESETN] [get_bd_pins ps_interconnect/S00_ARESETN] [get_bd_pins ps_reset/peripheral_aresetn] [get_bd_pins simple_timer/rst_n]

  # Create address segments
  create_bd_addr_seg -range 0x00020000 -offset 0x43CE0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/detector/S_AXI/S_AXI_ADDR] SEG_detector_S_AXI_ADDR
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x43C20000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs eth0/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR
  create_bd_addr_seg -range 0x00001000 -offset 0x43C40000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs eth1/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR1
  create_bd_addr_seg -range 0x00001000 -offset 0x43C60000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/eth2/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR2
  create_bd_addr_seg -range 0x00001000 -offset 0x43C80000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs mitm/eth3/stats/S_AXI/S_AXI_ADDR] SEG_stats_S_AXI_ADDR3
  create_bd_addr_seg -range 0x00002000 -offset 0x43CA0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs eth0/tgen/S_AXI/S_AXI_ADDR] SEG_tgen_S_AXI_ADDR
  create_bd_addr_seg -range 0x00002000 -offset 0x43CC0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs eth1/tgen/S_AXI/S_AXI_ADDR] SEG_tgen_S_AXI_ADDR4
  ...
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces dma/dma/M_AXI] [get_bd_addr_segs ps_main/S_AXI_ACP/ACP_IOP] SEG_ps_main_ACP_IOP
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces dma/dma/M_AXI] [get_bd_addr_segs ps_main/S_AXI_ACP/ACP_M_AXI_GP0] SEG_ps_main_ACP_M_AXI_GP0
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces dma/dma/M_AXI] [get_bd_addr_segs ps_main/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps_main_ACP_QSPI_LINEAR
