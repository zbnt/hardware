...
proc create_hier_cell_latency { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:mdio_io:1.0 mdio_loop
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:mdio_io:1.0 mdio_main
  ...
  set_property -dict [ list \
   ...
   CONFIG.main_mac {0xDEADBEEF0101} \
 ] $measurer

  # Create instance: measurer_rst, and set properties
  set measurer_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 measurer_rst ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $measurer_rst
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins mdio_loop] [get_bd_intf_pins eth3_mac/mdio_external]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins s_axi_mac_loop] [get_bd_intf_pins eth3_mac/s_axi]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins s_axi_mac_main] [get_bd_intf_pins eth2_mac/s_axi]
  ...
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins s_axi_stats_loop] [get_bd_intf_pins eth3_stats/S_AXI]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins mdio_main] [get_bd_intf_pins eth2_mac/mdio_external]
  ...
  connect_bd_intf_net -intf_net eth_measurer_0_M_AXIS_MAIN [get_bd_intf_pins eth2_mac/s_axis_tx] [get_bd_intf_pins measurer/M_AXIS_MAIN]
  connect_bd_intf_net -intf_net mac_loop_m_axis_rx [get_bd_intf_pins eth3_mac/m_axis_rx] [get_bd_intf_pins measurer/S_AXIS_LOOP]
  connect_bd_intf_net -intf_net mac_main_m_axis_rx [get_bd_intf_pins eth2_mac/m_axis_rx] [get_bd_intf_pins measurer/S_AXIS_MAIN]
  ...
  connect_bd_net -net ext_reset_in_0_1 [get_bd_pins rst_n] [get_bd_pins reset/ext_reset_in]
  connect_bd_net -net gtx_clk90_1 [get_bd_pins gtx_clk90] [get_bd_pins eth2_mac/gtx_clk90] [get_bd_pins eth3_mac/gtx_clk90]
  connect_bd_net -net mac_loop_rx_mac_aclk [get_bd_pins eth3_mac/rx_mac_aclk] [get_bd_pins eth3_stats/clk_rx] [get_bd_pins measurer/s_axis_loop_clk]
  connect_bd_net -net mac_loop_rx_statistics_valid [get_bd_pins eth3_mac/rx_statistics_valid] [get_bd_pins eth3_stats/rx_stats_valid]
  connect_bd_net -net mac_loop_rx_statistics_vector [get_bd_pins eth3_mac/rx_statistics_vector] [get_bd_pins eth3_stats/rx_stats_vector]
  connect_bd_net -net mac_loop_tx_statistics_valid [get_bd_pins eth3_mac/tx_statistics_valid] [get_bd_pins eth3_stats/tx_stats_valid]
  connect_bd_net -net mac_loop_tx_statistics_vector [get_bd_pins eth3_mac/tx_statistics_vector] [get_bd_pins eth3_stats/tx_stats_vector]
  connect_bd_net -net mac_main_rx_mac_aclk [get_bd_pins eth2_mac/rx_mac_aclk] [get_bd_pins eth2_stats/clk_rx] [get_bd_pins measurer/s_axis_main_clk]
  connect_bd_net -net mac_main_rx_statistics_valid [get_bd_pins eth2_mac/rx_statistics_valid] [get_bd_pins eth2_stats/rx_stats_valid]
  connect_bd_net -net mac_main_rx_statistics_vector [get_bd_pins eth2_mac/rx_statistics_vector] [get_bd_pins eth2_stats/rx_stats_vector]
  connect_bd_net -net mac_main_tx_statistics_valid [get_bd_pins eth2_mac/tx_statistics_valid] [get_bd_pins eth2_stats/tx_stats_valid]
  connect_bd_net -net mac_main_tx_statistics_vector [get_bd_pins eth2_mac/tx_statistics_vector] [get_bd_pins eth2_stats/tx_stats_vector]
  connect_bd_net -net mac_rst_dout [get_bd_pins eth2_mac/glbl_rstn] [get_bd_pins eth2_mac/rx_axi_rstn] [get_bd_pins eth2_mac/tx_axi_rstn] [get_bd_pins eth3_mac/glbl_rstn] [get_bd_pins eth3_mac/rx_axi_rstn] [get_bd_pins eth3_mac/tx_axi_rstn] [get_bd_pins mac_rst/dout]
  connect_bd_net -net reset_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins eth2_mac/s_axi_resetn] [get_bd_pins eth2_stats/rst_n] [get_bd_pins eth3_mac/s_axi_resetn] [get_bd_pins eth3_stats/rst_n] [get_bd_pins measurer/s_axi_resetn] [get_bd_pins reset/peripheral_aresetn]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins gtx_clk] [get_bd_pins eth2_mac/gtx_clk] [get_bd_pins eth2_mac/s_axi_aclk] [get_bd_pins eth2_stats/clk] [get_bd_pins eth3_mac/gtx_clk] [get_bd_pins eth3_mac/s_axi_aclk] [get_bd_pins eth3_stats/clk] [get_bd_pins measurer/s_axi_clk] [get_bd_pins reset/slowest_sync_clk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins eth2_mac/tx_ifg_delay] [get_bd_pins eth3_mac/tx_ifg_delay] [get_bd_pins mac_ifg/dout]
  connect_bd_net -net xlconstant_0_dout1 [get_bd_pins measurer/s_axis_loop_rst] [get_bd_pins measurer/s_axis_main_rst] [get_bd_pins measurer_rst/dout]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net eth1_mdio [get_bd_intf_ports ethfmc_p1_mdio] [get_bd_intf_pins eth1/mdio]
  ...
  connect_bd_intf_net -intf_net latency_mdio_loop [get_bd_intf_ports ethfmc_p3_mdio] [get_bd_intf_pins latency/mdio_loop]
  connect_bd_intf_net -intf_net latency_mdio_main [get_bd_intf_ports ethfmc_p2_mdio] [get_bd_intf_pins latency/mdio_main]
  ...
  connect_bd_intf_net -intf_net s_axi_mac_loop_1 [get_bd_intf_pins latency/s_axi_mac_loop] [get_bd_intf_pins ps_interconnect/M06_AXI]
  connect_bd_intf_net -intf_net s_axi_mac_main_1 [get_bd_intf_pins latency/s_axi_mac_main] [get_bd_intf_pins ps_interconnect/M07_AXI]
  connect_bd_intf_net -intf_net s_axi_measurer_1 [get_bd_intf_pins latency/s_axi_measurer] [get_bd_intf_pins ps_interconnect/M08_AXI]
  ...
  connect_bd_intf_net -intf_net s_axi_stats_loop_1 [get_bd_intf_pins latency/s_axi_stats_loop] [get_bd_intf_pins ps_interconnect/M10_AXI]
  connect_bd_intf_net -intf_net s_axi_stats_main_1 [get_bd_intf_pins latency/s_axi_stats_main] [get_bd_intf_pins ps_interconnect/M09_AXI]
  ...
  connect_bd_net -net M06_ARESETN_1 [get_bd_pins latency/axi_resetn] [get_bd_pins ps_interconnect/M06_ARESETN] [get_bd_pins ps_interconnect/M07_ARESETN] [get_bd_pins ps_interconnect/M08_ARESETN] [get_bd_pins ps_interconnect/M09_ARESETN] [get_bd_pins ps_interconnect/M10_ARESETN] [get_bd_pins ps_interconnect/M11_ARESETN] [get_bd_pins simple_timer/rst_n]
  ...
  connect_bd_net -net eth0_mac_gtx_clk90_out [get_bd_pins eth0/gtx_clk90_out] [get_bd_pins eth1/gtx_clk90] [get_bd_pins latency/gtx_clk90]
  ...
  connect_bd_net -net gtx_clk_1 [get_bd_pins eth0/gtx_clk_out] [get_bd_pins eth1/gtx_clk] [get_bd_pins latency/gtx_clk] [get_bd_pins ps_interconnect/M06_ACLK] [get_bd_pins ps_interconnect/M07_ACLK] [get_bd_pins ps_interconnect/M08_ACLK] [get_bd_pins ps_interconnect/M09_ACLK] [get_bd_pins ps_interconnect/M10_ACLK] [get_bd_pins ps_interconnect/M11_ACLK] [get_bd_pins simple_timer/clk]
  connect_bd_net -net ps_main_FCLK_RESET0_N [get_bd_pins eth0/rst_n] [get_bd_pins eth1/rst_n] [get_bd_pins latency/rst_n] [get_bd_pins ps_main/FCLK_RESET0_N] [get_bd_pins ps_reset/ext_reset_in]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs latency/eth2_mac/s_axi/Reg] SEG_eth2_mac_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43CA0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs latency/eth2_stats/S_AXI/S_AXI_ADDR] SEG_eth2_stats_S_AXI_ADDR
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs latency/eth3_mac/s_axi/Reg] SEG_eth3_mac_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43CB0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs latency/eth3_stats/S_AXI/S_AXI_ADDR] SEG_eth3_stats_S_AXI_ADDR
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43CC0000 [get_bd_addr_spaces ps_main/Data] [get_bd_addr_segs latency/measurer/S_AXI/S_AXI_ADDR] SEG_measurer_S_AXI_ADDR
