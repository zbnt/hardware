...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_regslice_M_AXIS [get_bd_intf_pins dma/S_AXIS_S2MM] [get_bd_intf_pins fifo_5/M_AXIS]
  ...
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins axi_converter/aclk] [get_bd_pins axi_regslice/aclk] [get_bd_pins dma/clk] [get_bd_pins fifo_0/s_axis_aclk] [get_bd_pins fifo_1/s_axis_aclk] [get_bd_pins fifo_2/s_axis_aclk] [get_bd_pins fifo_3/s_axis_aclk] [get_bd_pins fifo_4/s_axis_aclk] [get_bd_pins fifo_5/s_aclk] [get_bd_pins switch/aclk]
  connect_bd_net -net fifo_5_axis_rd_data_count [get_bd_pins dma/fifo_occupancy] [get_bd_pins fifo_5/axis_data_count]
  connect_bd_net -net rst_n_1 [get_bd_pins dma/fifo_rst_n] [get_bd_pins fifo_0/s_axis_aresetn] [get_bd_pins fifo_1/s_axis_aresetn] [get_bd_pins fifo_2/s_axis_aresetn] [get_bd_pins fifo_3/s_axis_aresetn] [get_bd_pins fifo_4/s_axis_aresetn] [get_bd_pins switch/aresetn]
  connect_bd_net -net rst_n_2 [get_bd_pins rst_n] [get_bd_pins axi_converter/aresetn] [get_bd_pins axi_regslice/aresetn] [get_bd_pins dma/rst_n] [get_bd_pins fifo_5/s_aresetn]
